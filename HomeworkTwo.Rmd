...
```{r}
wizards <- c('harry','ron','george','fred','sirius')
wizards
ranking <- c('4','2','5','1','3')
ranking
...
years
income <- c(22.000,67.000,70.000,72.000)
income
expenses <- c(3.000,23.000,32.000,35.000)
expenses
savings <- c(19.000,44.000,38.000,37.000)
savings
```
